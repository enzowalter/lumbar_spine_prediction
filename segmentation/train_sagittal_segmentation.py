        ...
        for s_id in series_id:
            ...
            if len(coordinates_dict) == len(LEVELS):
                ...
                for coordinate in coordinates_dict:
                    ...
                    dataset_item['output_mask'][idx_level][y-10:y+10,x-10:x+10] = 1
...
if __name__ == "__main__":
    ...
    #         "model_segmentation_st2_224x224.ts",
    #     )
    m2 = train_model_sagittal(
                ...
                "model_segmentation_st1_right_384x384.ts",
            )
    m3 = train_model_sagittal(
                ...
                "model_segmentation_st1_left_384x384.ts",
            )