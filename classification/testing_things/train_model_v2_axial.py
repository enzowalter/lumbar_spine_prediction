...
def generate_dataset(input_dir, crop_description, crop_conditions, crop_size, image_resize):
    ...
    for crop_condition in crop_conditions:
        ...
        for study_id in tqdm.tqdm(studies_id, desc=f"Generates classification dataset condition {crop_condition}"):
...
def train_submodel(input_dir, model_name, crop_description, crop_conditions, crop_size, image_resize):
    ...
    model = REM(
        n_classes=3,
        backbones = ['focalnet_small_lrf.ms_in1k', 'convnextv2_tiny.fcmae_ft_in1k', 'dm_nfnet_f0.dm_in1k', 'ecaresnet26t.ra2_in1k', 'cspresnet50.ra_in1k'],
        n_classifiers=3,
...
if __name__ == "__main__":
    ...
    best = train_submodel(
        input_dir="../",
        model_name="classification_axial.pth",
        crop_conditions=["Left Subarticular Stenosis", "Right Subarticular Stenosis"],
