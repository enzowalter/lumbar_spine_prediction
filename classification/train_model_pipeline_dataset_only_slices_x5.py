...
def get_best_slice_selection(input_size, device, slice_model, pathes):
    ...
    for level in range(preds_model.shape[0]):
        ...
        _, max_indice = get_max_consecutive_N(pred_level, 5)
...
def train_submodel(input_dir, model_name, crop_description, crop_condition, crop_size, image_resize, slice_model):
    ...
    for epoch in range(15):
        ...
        if metrics['concat_loss'] < best:
            ...
            n_model = REM_5x_Script(n_classes=3, n_fold_classifier=3, backbones=backbones_1024)
...
if __name__ == "__main__":
    ...
    out_name = ["classification_st1_left_x5.ts", "classification_st1_right_x5.ts", "classification_st2_x5.ts", "classification_ax_left_x5.pth", "classification_ax_right_x5.pth"]
