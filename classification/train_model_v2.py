...
def policy_loss(m, selected_crops, reward):
    log_prob = m.log_prob(selected_crops)  # Log probability for the selected crops
    return (-log_prob * reward).mean()  # Return the loss

def compute_normalized_rewards(reward):
...
if __name__ == "__main__":
    ...
    # 0.5395534634590149 from 5 crops
    # 0.5392992496490479 from 3 crops
    # 0.5459481477737427 from 3 crops cat after encoder
    # 0.5553274750709534 from 3 crops in rgb
    # 0.5255224108695984, 0.4972788095474243 from 1 best crop expanded
    # 0.6526274681091309 0.5980035662651062 from 1 crop (best index - 1) expanded
