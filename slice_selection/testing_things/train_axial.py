...
from models import AxialSliceSelecterModel
...
if __name__ == "__main__":
    train_model("../", "Right Subarticular Stenosis", "Axial T2", "model_slice_selection_axt2_right_scripted.ts")
